...
export const JobPostCard = (
    ...
    const getComments = (item: Comments) => {
        return (
            <Pressable onPress={() => { router.push({ pathname: "/screens/SpecialistDetails", params: { specialistID: item.specialistID } }) }} >
    ...
    return (
        <Pressable style={style} key={jobPost.ID} onPress={onPress}>
